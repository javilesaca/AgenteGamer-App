...
/**
 * Clase de dominio que implementa el sistema de evaluación financiera.
 * Calcula recomendaciones de compra basadas en presupuesto, gastos actuales
 * y precio del juego. Define umbrales de color (verde, amarillo, rojo).
 */
