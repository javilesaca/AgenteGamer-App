...
/**
 * ViewModel para la gestión de la wishlist y lógica financiera.
 * Maneja la lista de juegos deseados, evaluación de compras,
 * sincronización con lanzamientos y cálculos del sistema financiero.
 */
@HiltViewModel
